...
function createLLMResponseHTML(data: any): string {
    const {
        model = 'Unknown',
        content = '',
        cost = 0,
...
function setupEventHandlers(element: HTMLElement, data: any, context: any) {
...
function setupStreamingUpdates(element: HTMLElement, data: any, context: any) {
