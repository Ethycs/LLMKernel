...
exports.KernelProvider = void 0;
const vscode = __importStar(require("vscode"));
const kernelService_1 = require("../services/kernelService");
class KernelProvider {
    constructor() {
        this.kernelService = new kernelService_1.KernelService();
    }
    startKernel() {
    ...
    sendRequest(request) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const response = yield this.kernelService.executeCode(JSON.stringify(request));
                return response;
            }
            catch (error) {
    ...
    getKernelStatus() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const status = yield this.kernelService.getKernelStatus();
                return status;
            }
            catch (error) {
